...
const upDateProject = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        const updatedResult = await result.save({ transaction: t });
                        ...
                        if (Model) {
                            const existingRecord = await Model.findOne({
                                where: {
                                    ...
                                    // someUniqueField: record.someUniqueField,  // the unique field
                                },
                                transaction: t
                            });
                            ...
                            if (existingRecord) {
                                ...
                                await Model.create({ ...record, product_id: updatedResult.id }, { transaction: t });
                            }
                        }
                    }
